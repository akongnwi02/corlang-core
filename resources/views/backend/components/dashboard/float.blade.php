<div class="modal fade" id="floatAccount" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalCenterTitle">
                    @lang('labels.backend.account.float')
{{--                    <small class="text-muted">@lang('labels.backend.account.float')</small>--}}
                </h4>
