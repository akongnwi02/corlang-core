...
@section('content')
    {{ html()->modelForm($currency, 'PUT', route('admin.administration.currency.update', $currency))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('labels.backend.administration.currency.edit')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
