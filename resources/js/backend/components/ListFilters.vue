...
<template>
    <transition name="slide-in-top">
        <div class="large-12 medium-12 small-12 cell list-filters-container"><!--insert v condition here for displaying the filters-->
                    ...
                    <div class="grid-x grid-padding-x">
                        <div class="large-6 medium-6 small-12 cell">
                            <!--<span class="clear-filters" v-show="showFilters" v-on:click="clearFilters()">-->
                                <img src="/img/backend/icons/clear-filters-icon.svg"/> Clear filters
                            <!--</span>-->
                            <div class="grid-x grid-padding-x">
                                <div class="large-12 medium-12 small-12 cell">
                                    <label class="filter-label">Meter or Transaction Code</label>
                                </div>
                            </div>
    ...
    */
    ...
    export default {
        ...
        */
        watch: {
            /*
              Watches the landlord filter
            */
            'landlordFilter': function(){
                /*
                  If the landlord filter changes and is not empty, we begin
                  navigation to the landlord page.
                */
                if( this.landlordFilter != '' ){
                    let slug = '';

                    /*
                      We find the slug of the landlord that matches the id from the filter.
                    */
                    for( let i = 0; i < this.landlord.length; i++ ){
                        if( this.landlords[i].id == this.landlordFilter ){
                            slug = this.landlords[i].slug;
                        }
                    }
