...
class ServiceRepository
{
    ...
    public function update(Service $service, $data, $logo = null)
    {
        return \DB::transaction(function () use ($service, $data, $logo) {
            ...
            $service->is_balance_check_supported = request()->has('is_balance_check_supported') ? 1 : 0;
    ...
    public function getServicesWithBalanceSupport()
    {
        Return Service::where('is_balance_check_supported', true);
    }
